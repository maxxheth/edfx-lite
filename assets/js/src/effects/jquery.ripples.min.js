...
const RippleFactoryInit = $ => {
    ...
    Ripples.prototype = {
        ...
        computeTextureBoundaries: function() {
            ...
            var scale, backgroundWidth, backgroundHeight;
            ...
            this.renderProgram.uniforms.bottomRight = new Float32Array([
                this.renderProgram.uniforms.topLeft[0] +
                    this.$el.innerWidth() / backgroundWidth,
                this.renderProgram.uniforms.topLeft[1] +
                    this.$el.innerHeight() / backgroundHeight
            ]);
        ...
        //     // gl.globalCompositeOperation = style;
...
export default RippleFactoryInit;
