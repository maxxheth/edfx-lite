        ...
        for (let i = 8; i < snapStopArr.length; i++) {
            ...
            setInterval(() => {
                ...
                setTimeout(() => {
                    ...
                    snapStopArr[i].animate({ 'stop-opacity' : 1 }, 1200 / Math.PI , mina.easeinout);
        ...
        anime({
          ...
          loop: false, 
            update: function(anim, currentTime) {
                ...
                snapStopSet01.forEach(arr => arr.animate({ 'stop-opacity' : 1}, 1000, mina.backin));
        ...
        anime({
          ...
          loop: false, 
            update: function(anim, currentTime) {
                ...
                snapStopSet02.forEach(arr => arr.animate({ 'stop-opacity' : 1}, 900, mina.backin));
        ...
        anime({
          ...
          loop: false, 
            update: function(anim, currentTime) {
                ...
                snapStopSet03.forEach(arr => arr.animate({ 'stop-opacity' : 1}, 1000, mina.backin));
        ...
        anime({
          ...
          loop: false, 
            update: function(anim, currentTime) {
                ...
                snapStopSet04.forEach(arr => arr.animate({ 'stop-opacity' : 1 }, 1100, mina.backin));
