            ...
            (s.VantaBase = class {
                constructor(e = {}) {
                    ...
                    if (
                        ...
                        (this.windowTouchWrapper = this.windowTouchWrapper.bind(
                            this
                        )),
                    ...
                    try {
                        ...
                        return (
                            ...
                            void (
                                ...
                                (console.log(
                                    "[VANTA] Falling back to backgroundColor"
                                ),
                    ...
                    l("resize", this.resize),
                        this.resize(),
                        this.animationLoop(),
                        l("scroll", this.windowMouseMoveWrapper),
                        l("mousemove", this.windowMouseMoveWrapper),
                        l("touchstart", this.windowTouchWrapper),
                ...
                windowMouseMoveWrapper(e) {
                    ...
                    n >= 0 &&
                        ...
                        ((this.mouseX = n),
                        (this.mouseY = o),
                        this.options.mouseEase || this.triggerMouseMove(n, o));
                }
                windowTouchWrapper(e) {
                    if (1 === e.touches.length) {
                        ...
                        if (!t) return !1;
                        const i = t.getBoundingClientRect(),
                            n = e.touches[0].clientX - i.left,
                            o = e.touches[0].clientY - i.top;
                        n >= 0 &&
                            o >= 0 &&
                            n <= i.width &&
                            o <= i.height &&
                ...
                animationLoop() {
                    return (
                        ...
                        this.uniforms &&
                            (this.uniforms.u_time.value = 0.016667 * this.t2),
                        this.options.mouseEase &&
                            ((this.mouseEaseX =
                                this.mouseEaseX || this.mouseX || 0),
                            (this.mouseEaseY =
                                this.mouseEaseY || this.mouseY || 0),
        ...
        17: function(e, t, i) {
            ...
            function r(e, t, i) {
                ...
                n.add(a),
                            ...
                            if (null !== o.dependencies)
                                for (
                                    ...
                                    if (l.name !== o.name) {
                                        for (
                                            var h = !1, c = 0;
                                            c < this.variables.length;
                                            c++
                                        )
                                            if (
                                                l.name ===
                                                this.variables[c].name
                                            ) {
                                                h = !0;
                                                break;
                                            }
                    ...
                    (this.compute = function() {
                        for (
                            var e = this.currentTextureIndex,
                    ...
                    (this.getAlternateRenderTarget = function(e) {
                        return e.renderTargets[
                            0 === this.currentTextureIndex ? 1 : 0
                        ];
                    }),
                    (this.addResolutionDefine = l),
                    (this.createShaderMaterial = h),
                    (this.createRenderTarget = function(i, n, o, r, s, a) {
                        return (
                            (i = i || e),
                            (n = n || t),
                            (o = o || THREE.ClampToEdgeWrapping),
                            (r = r || THREE.ClampToEdgeWrapping),
                            (s = s || THREE.NearestFilter),
                            (a = a || THREE.NearestFilter),
                    ...
                    (this.renderTexture = function(e, t) {
                        (r.texture.value = e),
                            this.doRenderTarget(s, t),
                            (r.texture.value = null);
                    }),
            ...
            var p = function(e) {
                ...
                (this.position = new s.Vector3()),
                    ...
                    (this.run = function(e) {
                        n.set(-o, this.position.y, this.position.z),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            n.set(o, this.position.y, this.position.z),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            n.set(this.position.x, -r, this.position.z),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            n.set(this.position.x, r, this.position.z),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            n.set(this.position.x, this.position.y, -a),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            n.set(this.position.x, this.position.y, a),
                            (n = this.avoid(n)).multiplyScalar(5),
                            t.add(n),
                            Math.random() > 0.5 && this.flock(e),
                            this.move();
                    }),
                    (this.flock = function(e) {
                        i && t.add(this.reach(i, 0.005)),
                    ...
                    (this.move = function() {
                        ...
                        e > 2.5 && this.velocity.divideScalar(e / 2.5),
                            this.position.add(this.velocity),
                            t.set(0, 0, 0);
                    }),
                    (this.checkBounds = function() {
                        this.position.x > o && (this.position.x = -o),
                            this.position.x < -o && (this.position.x = o),
                    ...
                    (this.avoid = function(e) {
                        ...
                        return (
                            ...
                            t.sub(e),
                            t.multiplyScalar(
                                1 / this.position.distanceToSquared(e)
                            ),
                            t
                        );
                    }),
                    (this.repulse = function(e) {
                        ...
                        if (i < 150) {
                            var n = new s.Vector3();
                            n.subVectors(this.position, e),
                                n.multiplyScalar(0.5 / i),
                                t.add(n);
                        }
                    }),
                    ...
                    (this.cohesion = function(e) {
                        ...
                        for (var h = 0, c = e.length; h < c; h++)
                            Math.random() > 0.6 ||
                                ((i = (t = e[h]).position.distanceTo(
                                    this.position
                                )) > 0 &&
                                    i <= a &&
                                    (n.add(t.position), r++));
                        r > 0 && n.divideScalar(r),
                            o.subVectors(n, this.position);
                        var u = o.length();
                        return u > 0.1 && o.divideScalar(u / 0.1), o;
                    }),
                        ...
                        for (var a = 0, h = e.length; a < h; a++)
                            Math.random() > 0.6 ||
                                ((i = (t = e[a]).position.distanceTo(
                                    ...
                                    i <= r &&
                                    (o.subVectors(this.position, t.position),
                                    o.normalize(),
                                    o.divideScalar(i),
                                    n.add(o)));
                        return n;
            ...
            (s.BirdGeometry = function(e) {
                ...
                this.addAttribute("position", n),
                    this.addAttribute("birdColor", o),
                    this.addAttribute("reference", r),
                    this.addAttribute("birdVertex", a);
                let c = 0;
                const u = function() {
                        for (let e = 0; e < arguments.length; e++)
                            n.array[c++] = arguments[e];
                    },
                    d = e.wingSpan || 20,
                    p = e.birdSize || 1;
                for (let e = 0; e < h; e++)
                    u(0, -0, -20 * p, 0, 4 * p, -20 * p, 0, 0, 30 * p),
                        u(0, 0, -15 * p, -d * p, 0, 0, 0, 0, 15 * p),
                        u(0, 0, 15 * p, d * p, 0, 0, 0, 0, -15 * p);
                const f = {};
                for (c = 0; c < 3 * t; c++) {
                    const t = ~~(c / 3),
                    ...
                    let p;
                    (p = !d && f[u] ? f[u] : e.effect.getNewCol(s)),
                        d || f[u] || (f[u] = p),
                        (o.array[3 * c + 0] = p.r),
                        (o.array[3 * c + 1] = p.g),
                        (o.array[3 * c + 2] = p.b),
                ...
                (s.BirdGeometry.prototype = Object.create(
                    s.BufferGeometry.prototype
                ));
            class b extends n.b {
                static initClass() {
                ...
                initComputeRenderer() {
                    ...
                    g(e),
                        ...
                        (this.velocityVariable.material.defines.BOUNDS = c.toFixed(
                            2
                        )),
                        (this.velocityVariable.wrapS = s.RepeatWrapping),
                        (this.velocityVariable.wrapT = s.RepeatWrapping),
                        (this.positionVariable.wrapS = s.RepeatWrapping),
                        (this.positionVariable.wrapT = s.RepeatWrapping);
                ...
                initGpgpuBirds() {
                    ...
                    this.birdUniforms = {
                        color: { value: new s.Color(16720384) },
                ...
                getNewCol(e) {
                    ...
                    if (
                        ((l =
                            -1 != t.colorMode.indexOf("Gradient")
                                ? Math.random()
                                : e),
                        0 == t.colorMode.indexOf("variance"))
                    ) {
                ...
                onInit() {
                    (this.camera = new s.PerspectiveCamera(
                        ...
                        (this.fog = new s.Fog(16777215, 100, 1e3)),
                    ...
                    if (a)
                        try {
                            this.initComputeRenderer(),
                                (this.valuesChanger = this.valuesChanger.bind(
                                    this
                                )),
                                this.valuesChanger(),
                                this.initGpgpuBirds();
                        ...
                        for (var r = 0; r < a; r++) {
                            ...
                            for (var l = 0; l < u.faces.length; l++)
                                if (c)
                                    ...
                                    (u.faces[l].vertexColors[0] = e),
                                        (u.faces[l].vertexColors[1] = e),
                                        (u.faces[l].vertexColors[2] = e);
                                }
                            ((o = e[r] = new s.Mesh(
                                u,
                                ...
                                (o.position.x = t[r].position.x),
                                (o.position.y = t[r].position.y),
                                (o.position.z = t[r].position.z),
                                this.scene.add(o);
                        }
                    }
                }
                ...
                onUpdate() {
                    (this.now = performance.now()),
                        this.last || (this.last = this.now);
                    let e = (this.now - this.last) / 1e3;
                    if ((e > 1 && (e = 1), (this.last = this.now), a))
                        (this.positionUniforms.time.value = this.now),
                            (this.positionUniforms.delta.value = e),
                            (this.velocityUniforms.time.value = this.now),
                            (this.velocityUniforms.delta.value = e),
                            (this.birdUniforms.time.value = this.now),
                            (this.birdUniforms.delta.value = e),
                        ...
                        for (var t = 0, i = e.length; t < i; t++)
                            (o = n[t]).run(n),
                                ((r = e[t]).rotation.y = Math.atan2(
                                    -o.velocity.z,
                                    o.velocity.x
                                )),
                                (r.rotation.z = Math.asin(
                                    o.velocity.y / o.velocity.length()
                                )),
                                (r.phase =
                                    (r.phase +
                                        (Math.max(0, r.rotation.z) + 0.1)) %
                                    62.83),
                                (r.geometry.vertices[5].y = r.geometry.vertices[4].y =
                                    5 *
                                    Math.sin(r.phase) *
                                    this.options.birdSize),
                                (r.geometry.verticesNeedUpdate = !0),
                                (r.position.x = n[t].position.x),
                                (r.position.y = n[t].position.y),
                                (r.position.z = n[t].position.z);
                    }
                }
                onMouseMove(e, t) {
                    if (
                        ((this.mouseX = e - 0.5), (this.mouseY = t - 0.5), !a)
                    ) {
                        const e = this.boids;
                        let t;
                        for (
                            ...
                            (t = e[n]), (i.z = t.position.z), t.repulse(i);
                    }
                }
                onDestroy() {}
                onResize() {}
