...
export default !(function (e, t) {
	...
	return (function (e) {
		...
		1: function (e, t, i) {
			...
			(s.register = (e, t) => (s[e] = (e) => new t(e))), (s.version = "0.5.4");
			const a = function () {
				return (
				...
				constructor(e = {}) {
					...
					for (t = 0; t < this.el.children.length; t++)
						(i = this.el.children[t]),
							...
							"auto" === getComputedStyle(i).zIndex && (i.style.zIndex = 1);
				...
				n.add(a),
					...
					(this.compute = function () {
						for (
							...
							if (null !== o.dependencies)
								for (
									var r = o.material.uniforms, s = 0, a = o.dependencies.length;
									s < a;
									s++
								) {
				...
				(this.position = new s.Vector3()),
					...
					(this.alignment = function (e) {
						...
						for (var a = 0, h = e.length; a < h; a++)
							Math.random() > 0.6 ||
								((i = (t = e[a]).position.distanceTo(this.position)) > 0 &&
									i <= r &&
									(n.add(t.velocity), o++));
						if (o > 0) {
							n.divideScalar(o);
					...
					(this.cohesion = function (e) {
						...
						for (var h = 0, c = e.length; h < c; h++)
							Math.random() > 0.6 ||
								((i = (t = e[h]).position.distanceTo(this.position)) > 0 &&
									i <= a &&
									(n.add(t.position), r++));
			...
			class b extends n.b {
				...
				initComputeRenderer() {
					...
					g(e),
						...
						(this.velocityVariable.material.defines.BOUNDS = c.toFixed(2)),
				...
				getNewCol(e) {
					...
					let a, l;
					if (
						((l = -1 != t.colorMode.indexOf("Gradient") ? Math.random() : e),
				...
				onInit() {
					...
					if (a)
						...
						for (var r = 0; r < a; r++) {
							((n = t[r] = new p(i)).position.x = 400 * Math.random() - 200),
					...
					if ((e > 1 && (e = 1), (this.last = this.now), a))
						...
						for (var t = 0, i = e.length; t < i; t++)
							(o = n[t]).run(n),
								...
								(r.rotation.z = Math.asin(o.velocity.y / o.velocity.length())),
								(r.phase =
									(r.phase + (Math.max(0, r.rotation.z) + 0.1)) % 62.83),
								(r.geometry.vertices[5].y = r.geometry.vertices[4].y =
									5 * Math.sin(r.phase) * this.options.birdSize),
				...
				onMouseMove(e, t) {
					if (((this.mouseX = e - 0.5), (this.mouseY = t - 0.5), !a)) {
						const e = this.boids;
						let t;
						for (
							var i = new s.Vector3(
