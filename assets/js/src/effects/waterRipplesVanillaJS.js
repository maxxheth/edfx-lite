...
head.insertAdjacentHTML('beforeend', '<style>.vanilla-js-ripples { position: relative; z-index: 0; }</style>');

// RIPPLES CLASS DEFINITION
// =========================

export const Ripples = function (el, options = {
    imageUrl: null,
    resolution: 256,
    dropRadius: 20,
    perturbance: 0.03,
...
Ripples.prototype = {
    ...
    computeTextureBoundaries: function() {
        ...
        let backgroundPosition = translateBackgroundPosition(this.el.style.backgroundPosition);
