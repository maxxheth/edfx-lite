...
head.insertAdjacentHTML(
    "beforeend",
    "<style>.vanilla-js-ripples { position: relative; z-index: 0; }</style>"
);

// RIPPLES CLASS DEFINITION
// =========================

export const Ripples = function(
    el,
    options = {
        imageUrl: null,
        resolution: 256,
    ...
    this.el.classList.add("vanilla-js-ripples");
...
Ripples.prototype = {
    ...
    setupPointerEvents: function() {
        ...
        this.el.addEventListener("mousemove", e => {
            if (!e.target.matches(".ripples")) return;
    ...
    loadImage: function() {
        ...
        image.crossOrigin = isDataUri(this.imageSource)
            ? null
            : this.crossOrigin;
    ...
    computeTextureBoundaries: function() {
        ...
        let backgroundSize = this.el.style.backgroundSize;
        //var backgroundAttachment = this.$el.css('background-attachment');
        let backgroundAttachment = this.el.style.backgroundAttachment;
        //var backgroundPosition = translateBackgroundPosition(this.$el.css('background-position'));
        let backgroundPosition = translateBackgroundPosition(
        ...
        if (backgroundAttachment == "fixed") {
            ...
            container.width = getWindowWidth();
            container.height = getWindowHeight();
        } else {
            //container = this.$el.offset();

            container = getOffset(this.el);
        ...
        if (backgroundSize == "cover") {
            ...
            if (isPercentage(backgroundWidth)) {
                backgroundWidth =
                    (container.width * parseFloat(backgroundWidth)) / 100;
        ...
        if (isPercentage(backgroundX)) {
            backgroundX =
                container.left +
                ((container.width - backgroundWidth) *
        ...
        let elementOffset = getOffset(this.el);
    ...
    hideCssBackground: function() {
        ...
        let inlineCss = this.el.style.backgroundImage;
    ...
    dropAtPointer: function(pointer, radius, strength) {
        let borderLeft = parseInt(this.el.style.borderLeftWidth) || 0,
            borderTop = parseInt(this.el.style.borderTopWidth) || 0;

        this.drop(
            pointer.pageX - getOffset(this.el).left - borderLeft,
            pointer.pageY - getOffset(this.el).top - borderTop,
            radius,
            strength
        );
    },
    ...
    destroy: function() {
        ...
        this.el.classList.remove("vanilla-js-ripples");
