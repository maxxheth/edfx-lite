        ...
        var c = (function(b) {
            ...
            d = (function(a) {
                function c(a, b) {
                    if (a) {
                        ...
                        if (null == b)
                            try {
                                return (
                                    (a = y.doc.querySelector(String(a))), w(a)
                                );
                            } catch (d) {
                                return null;
                            }
                ...
                var z = "hasOwnProperty",
                    ...
                    S = function(a) {
                        return (
                            (a && a.type ? a.type : I) + R + (Q++).toString(36)
                        );
                    },
                              ...
                              j[5]
                                  ? ((i = j[5].split(L)),
                                    ...
                                    ("deg" == i[0].slice(-3) ||
                                        "°" == i[0].slice(-1)) &&
                                        (b /= 360),
                                    "hsba" == j[1].toLowerCase().slice(0, 4) &&
                                        (g = B(i[3])),
                                    i[3] && "%" == i[3].slice(-1) && (g /= 100),
                                    c.hsb2rgb(b, d, f, g))
                                  : j[6]
                                  ? ((i = j[6].split(L)),
                                    ...
                                    ("deg" == i[0].slice(-3) ||
                                        "°" == i[0].slice(-1)) &&
                                        (b /= 360),
                                    "hsla" == j[1].toLowerCase().slice(0, 4) &&
                                        (g = B(i[3])),
                                    i[3] && "%" == i[3].slice(-1) && (g /= 100),
                                    c.hsl2rgb(b, d, f, g))
                                  : ((b = F(D.round(b), 255)),
        ...
        return (
            d.plugin(function(c, d, e, f, g) {
                ...
                (k.data = function(a, d) {
                    ...
                    return (
                        (e[a] = d),
                        b("snap.data.set." + this.id, this, d, a),
                        this
                    );
                }),
                ...
                (j.push = function() {
                    ...
                    (j.splice = function(a, b, c) {
                        ...
                        for (d = 0; d < k + e.length; d++)
                            this.items[a + d] = this[a + d] =
                                k > d ? j[d] : e[d - k];
                        for (
                            d = this.items.length = this.length -= b - k;
                            this[d];
            ...
            d.plugin(function(a, c, d, e) {
                ...
                function g(b, c, d) {
                    (b = b || new a.Matrix()),
                        (c = c || new a.Matrix()),
                        (b =
                            a.parseTransformString(b.toTransformString()) ||
                            []),
                        (c =
                            a.parseTransformString(c.toTransformString()) ||
                            []);
                    for (
                        var e,
                            g,
