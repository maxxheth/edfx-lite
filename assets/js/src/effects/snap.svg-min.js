...
!(function (a) {
	...
	(eve = function (a, d) {
		...
		for (var q = 0, r = h.length; r > q; q++)
			"zIndex" in h[q] &&
				(m.push(h[q].zIndex), h[q].zIndex < 0 && (n[h[q].zIndex] = h[q]));
		for (m.sort(i); m[j] < 0; )
		...
		(eve.on = function (a, b) {
			...
			for (
				var c = o(a) ? (o(a[0]) ? a : [a]) : n(a).split(g), d = 0, e = c.length;
				e > d;
				d++
			)
				!(function (a) {
					for (
						var c, d = o(a) ? a : n(a).split(f), e = j, g = 0, h = d.length;
						h > g;
						g++
					)
						(e = e.n),
					...
					for (d = 0, i = c.length; i > d; d++)
						for (p = 0; p < r.length; p += m.length - 2) {
							if (((m = [p, 1]), (k = r[p].n), c[d] != h))
								...
								for (l in k)
									k[e](l) && (m.push(k[l]), s.unshift({ n: k, name: l }));
							r.splice.apply(r, m);
						}
		...
		var c = (function (b) {
				var c,
					...
					p = function () {
						var a = this;
						a.pdif &&
							((a.b = a.get() - a.pdif), delete a.pdif, (d[a.id] = a), r());
					},
					q = function () {
						var a,
							b = this;
		...
		return (
			d.plugin(function (c, d, e, f, g) {
				...
				k.getBBox = function (a) {
					...
					try {
						return a
							? ((f.bboxwt = g
									? c.path.getBBox((b.realPath = g(b)))
									: c._.box(b.node.getBBox())),
							  c._.box(f.bboxwt))
							: ((b.realPath = g(b)),
							  (b.matrix = b.transform().localMatrix),
							  (f.bbox = c.path.getBBox(
									c.path.map(b.realPath, d.add(b.matrix)),
							  )),
							  c._.box(f.bbox));
					} catch (h) {
						return c._.box();
				...
				!(function (b) {
					...
					(b.add = function (a, b, c, d, e, g) {
						...
						(b.split = function () {
							...
							return (
								0 > g
									? ((b.rotate = a.deg(i.acos(g))),
									  0 > f && (b.rotate = 360 - b.rotate))
			...
			d.plugin(function (a, c, d, e, f) {
				...
				b.on("snap.util.grad.parse", function (a) {
					...
					return (
						(f[g].offset = f[g].offset || 100),
						b(g, f[g].offset),
						{ type: d, params: e, stops: f }
					);
				}),
					...
					if (c) {
						...
						if (
							(m && m == h
								...
								: ((f = this.asPX(e)),
								  (a = n(this.asPX(e), this.asPX(e, c[2] + h)))),
							isNaN(f) || isNaN(a))
						)
							return;
						(g[e] = a), this.attr(g);
			...
			d.plugin(function (c, d, e, f, g) {
				...
				(h.image = function (a, b, d, e, f) {
					...
					(h.path = function (a) {
						var b;
						return (
							i(a, "object") && !i(a, "array") ? (b = a) : a && (b = { d: a }),
							this.el("path", b)
						);
					}),
					(h.group = h.g =
			...
			d.plugin(function (a, b, c, d) {
				...
				function j(c, d) {
					...
					return a._.cacher(
						function (a, f, g) {
							...
							for (
								var h, j, l, m, n, o = "", p = {}, q = 0, r = 0, s = a.length;
								s > r;
								r++
							) {
								if (((l = a[r]), "M" == l[0])) (h = +l[1]), (j = +l[2]);
									...
									if (
										((m = i(h, j, l[1], l[2], l[3], l[4], l[5], l[6])),
										q + m > f)
									) {
										if (d && !p.start) {
											if (
							...
							return (
								...
								(n = c
									...
									: d
									  ? p
									  : k(h, j, l[0], l[1], l[2], l[3], l[4], l[5], 1))
							);
						},
						null,
						a._.clone,
				...
				function x(a) {
					...
					a = G(a);
					for (
						var c, d = 0, g = 0, h = [], i = [], j = 0, k = a.length;
						k > j;
						j++
					)
						if (((c = a[j]), "M" == c[0]))
							(d = c[1]), (g = c[2]), h.push(d), i.push(g);
						else {
				...
				function B(b) {
					...
					for (
						...
						if (
							(f.push((n = [])), (o = b[q]), (d = o[0]), d != d.toUpperCase())
						)
			...
			d.plugin(function (a, d, e, f) {
				...
				(j.push = function () {
					...
					(j.getBBox = function () {
						for (
							var a = [], b = [], c = [], d = [], e = this.items.length;
							e--;
						)
			...
			d.plugin(function (a, c, d, e) {
				...
				function g(b, c, d) {
					...
					for (
						...
						for (
							k[o] = [], n[o] = [], e = 0, g = Math.max(h.length, i.length);
							g > e;
							e++
						)
						...
						n = function (a, b, c, d) {
							var e = h && j[b] ? j[b] : b,
								f = function (e) {
									...
									if (h && j[g](b))
										for (
											var n = 0, o = e.targetTouches && e.targetTouches.length;
											o > n;
											n++
										)
											if (
				...
				(a.filter = {}),
					...
					b.on("snap.util.attr.filter", function (d) {
						if (d instanceof c && "filter" == d.type) {
							b.stop();
							var e = d.node.id;
							e || (i(d.node, { id: d.id }), (e = d.id)),
								i(this.node, { filter: a.url(e) });
						}
						(d && "none" != d) ||
