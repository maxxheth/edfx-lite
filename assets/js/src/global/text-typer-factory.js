    ...
    const TextTypeProto = {
                ...
                setInterval(() => {
                    if (!isBlinking) {
                        wrap.style.borderRight =
                            "0.08em solid rgba(255,255,255,0)";

                        isBlinking = true;
                    } else {
                        wrap.style.borderRight =
                            "0.08em solid rgba(255,255,255,1)";
        ...
        start() {
            ...
            for (let i = 0; i < elements.length; i++) {
                ...
                let looponce =
                    elements[i].getAttribute("data-looponce") === "true";

                if (toRotate) {
                    const TextType = TextTypeFactory({
                        el:
                            elements[i] ||
                            document.querySelectorAll(this.el)[i],
                        toRotate:
                        ...
                        typewriterCont:
                            this.typewriterCont !== ""
                                ...
                                : "",
                        textSrcDir:
                            this.textSrcDir !== "" ? this.textSrcDir : "",
