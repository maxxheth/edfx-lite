...
export const contactModalToggle = () => {
    ...
    contactModalCloseButton.addEventListener(
        ...
        event => {
            ...
            const triggerDisplayNoneAfterAnim = new Promise(
                (resolve, reject) => {
                    try {
                        anime({
                            targets: contactModal,
...
export const contactModalAJAX = destination => {
    ...
    const contactModalEmailInput = document.querySelector(
        ".contact-modal-email"
    );
    ...
    const contactModalSubmitButton = contactModalForm.querySelector(
        '[type="submit"]'
    );
            ...
            PromisifiedAJAX.then(response => {
                ...
                if (sentBool) {
                    Swal.fire({
                        title: "Message sent!",
                        html:
                            "<p>We'll get back to you in 1-2 business days regarding your business enquiry. Thanks for reaching out!</p>",
                        icon: "success"
                    });
