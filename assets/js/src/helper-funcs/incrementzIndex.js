...
const incrementzIndexOnHover = (elemClass, zIndexNum, ...childClasses) => {
    ...
    const createZIndexEventHandler = callback => e => {
        ...
        if (e.target.matches) {
            ...
            if (e.target.matches(`.${elemClass}`) && !e.target.matches(`.master-${elemClass}`)) {
            ...
            childClasses.forEach((childClass) => {
                ...
                if (e.target.matches(`.${childClass}`) && e.target.parentNode.classList.contains(elemClass)) {
            ...
            childClasses.forEach((childClass, childClassIndex) => {
                ...
                if (e.target.classList.contains(childClass) && e.target.parentNode.classList.contains(elemClass)) {
